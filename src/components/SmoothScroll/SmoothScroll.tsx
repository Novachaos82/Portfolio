...
const SmoothScroll: FC<SmoothScrollProps> = ({ children }) => {
  ...
  return (
    <>
      <motion.div
        ref={scrollRef}
        style={{ y: spring as MotionValue<number> }} // translateY of scroll container using negative scroll value
        className="fixed top-0 left-0 overflow-hidden w-full will-change-transform"
      >
        {children}
      </motion.div>
